...
def train_target(args):
    ...
    max_iter = args.max_epoch * len(dset_loaders["target"])
    # print(len(dset_loaders["target"].dataset), len(dset_loaders["tar_test"].dataset), len(dset_loaders["test"].dataset))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--net', type=str, default='resnet50', help="vgg16, resnet18, resnet50, resnext50")
