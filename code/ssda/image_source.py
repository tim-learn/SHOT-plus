...
if __name__ == "__main__":
    ...
    parser.add_argument('--net', type=str, default='vgg16', help="resnet34, vgg16, resnet50, resnet101")
    ...
    parser.add_argument('--da', type=str, default='ssda')
    ...
    args.test_dset_path = folder + args.dset + '/unlabeled_target_images_' + names[args.t] + '_' + str(args.shot) + '.txt'
